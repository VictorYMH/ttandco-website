<template>
    <div class="left-nav-layout" :style="cssVars">
        <Header class="left-nav-layout-header" @toggle-mobile-nav="toggleMobileNav" @header-mounted="onHeaderMounted"
            ref="header" />
        ...
        <Footer class="left-nav-layout-footer" />
        <ScrollToTop />
        <!-- Popup Component -->
